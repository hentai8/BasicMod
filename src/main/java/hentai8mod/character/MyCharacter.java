...
import static hentai8mod.BasicMod.makeID;
import static hentai8mod.BasicMod.characterPath;
...
public class MyCharacter extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("Hentai8"); //This should match whatever you have in the CharacterStrings.json file
